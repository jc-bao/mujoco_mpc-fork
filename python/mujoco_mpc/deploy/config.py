...
class H1_maniConfig(H1Config):
    ...
    task_id = "H1 pnp"
    vicon_object_name = "lecar_h1_mpc_torso"
    ...
    q_default = np.array(
        [
            -0.000172523, 0.0040112, -0.706946, 0.815878, -0.40069,
            -0.00238181, 0.00391676, -0.70997, 0.81762, -0.399404,
            0.0,
            -0.0800015, 0.5, -0.0341996, 0.125914,
            -0.111715, -0.5, 0.0382024, 0.124549
        ]
    )
