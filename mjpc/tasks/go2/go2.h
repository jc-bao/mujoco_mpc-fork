...
#ifndef MJPC_TASKS_GO2_GO2_H_
#define MJPC_TASKS_GO2_GO2_H_
...
class Go2Flat : public Task {
 public:
  std::string Name() const override;
  std::string XmlPath() const override;
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Go2Flat* task)
...
class Go2Hill : public Task {
 public:
  ...
  class ResidualFn : public mjpc::BaseResidualFn {
   public:
    explicit ResidualFn(const Go2Hill* task, int current_mode = 0)
    ...
    void Residual(const mjModel* model, const mjData* data,
                  double* residual) const override;
   private:
    friend class Go2Hill;
    int current_mode_;
  };
  Go2Hill() : residual_(this) {}
  void TransitionLocked(mjModel* model, mjData* data) override;
