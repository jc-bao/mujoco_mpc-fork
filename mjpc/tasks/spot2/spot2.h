...
#ifndef MJPC_TASKS_SPOT2_SPOT2_H_
#define MJPC_TASKS_SPOT2_SPOT2_H_
...
namespace mjpc
{
    ...
    public:
        ...
        {
        public:
            explicit ResidualFn(const Spot2Flat *task)
...
#endif // MJPC_TASKS_SPOT2_SPOT2_H_
