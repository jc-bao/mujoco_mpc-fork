#ifndef MJPC_TASKS_G1_TRACKING_REALT_TASK_H_
#define MJPC_TASKS_G1_TRACKING_REALT_TASK_H_
...
namespace mjpc
{
    namespace g1
    {
        ...
        class TrackingRealtime : public Task
        {
        public:
            class ResidualFn : public mjpc::BaseResidualFn
            {
            public:
                explicit ResidualFn(const TrackingRealtime *task, int current_mode = 0,
                                    double reference_time = 0)
                    : mjpc::BaseResidualFn(task),
                      current_mode_(current_mode),
                      reference_time_(reference_time) {}

                // ------------- Residuals for G1 tracking_realtime task -------------
                //   Number of residuals:
            ...
            private:
                friend class TrackingRealtime;
                int current_mode_;
                double reference_time_;
            };

            TrackingRealtime() : residual_(this) {}
