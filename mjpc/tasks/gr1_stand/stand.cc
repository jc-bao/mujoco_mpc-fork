...
#include "mjpc/tasks/gr1_stand/stand.h"
...
namespace mjpc::GR1Stand
{

    std::string Stand::XmlPath() const
    {
        return GetModelPath("gr1_stand/task.xml");
    }
    std::string Stand::Name() const { return "GR1 Stand"; }
