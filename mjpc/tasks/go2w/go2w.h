#ifndef MJPC_TASKS_GO2W_GO2W_H_
#define MJPC_TASKS_GO2W_GO2W_H_
...
namespace mjpc
{
  ...
  public:
    ...
    {
    public:
      explicit ResidualFn(const Go2WFlat *task)
    ...
    private:
      ...
      //  ============  constants  ============
      constexpr static Go2WFoot kFootAll[kNumFoot] = {kFootFL, kFootHL,
                                                     kFootFR, kFootHR};
      constexpr static Go2WFoot kFootHind[2] = {kFootHL, kFootHR};
      constexpr static Go2WGait kGaitAll[kNumGait] = {kGaitStand, kGaitWalk,
      ...
      void FootStep(double step[kNumFoot], double time, Go2WGait gait) const;
      ...
      Go2WMode current_mode_ = kModeQuadruped;
  ...
  public:
    ...
    {
    public:
      explicit ResidualFn(const Go2WHill *task, int current_mode = 0)
    ...
    private:
      friend class Go2WHill;
      int current_mode_;
    };
    Go2WHill() : residual_(this) {}
    void TransitionLocked(mjModel *model, mjData *data) override;
