...
#ifndef MJPC_TASKS_GO2ARM_GO2ARM_H_
#define MJPC_TASKS_GO2ARM_GO2ARM_H_
...
namespace mjpc
{
    ...
    public:
        ...
        {
        public:
            explicit ResidualFn(const Go2Arm *task)
...
#endif // MJPC_TASKS_GO2ARM_GO2ARM_H_
